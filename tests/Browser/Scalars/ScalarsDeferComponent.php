...
class ScalarsDeferComponent extends Component
{
        ...
        <div>
            ...
            <div x-data x-init="
                $sprucewire.registerStore('main', {
                    intProp: $sprucewire.entangle('intProp').defer,
                    stringProp: $sprucewire.entangle('stringProp').defer,
                    boolProp: $sprucewire.entangle('boolProp').defer
                })
            ">
                <h1>Spruce</h1>
